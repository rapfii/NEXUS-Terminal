...
export async function GET(request: NextRequest) {
    ...
    try {
        const cacheKey = `gateio:${marketType}:${symbol}`;
        ...
        const data = await gateioAdapter.getInstrument(symbol, marketType);
        ...
        console.error('GateIO ticker API error:', error);
        return NextResponse.json(
